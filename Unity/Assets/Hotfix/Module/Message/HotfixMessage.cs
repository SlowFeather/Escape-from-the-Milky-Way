...
namespace ETHotfix {
  ...
  ///新版测试
  /// </summary>
  public partial class C2G_ClientLoginRequest : pb::IMessage {
    private static readonly pb::MessageParser<C2G_ClientLoginRequest> _parser = new pb::MessageParser<C2G_ClientLoginRequest>(() => (C2G_ClientLoginRequest)MessagePool.Instance.Fetch(typeof(C2G_ClientLoginRequest)));
    public static pb::MessageParser<C2G_ClientLoginRequest> Parser { get { return _parser; } }
  ...
  public partial class G2C_ClientLoginResponse : pb::IMessage {
    private static readonly pb::MessageParser<G2C_ClientLoginResponse> _parser = new pb::MessageParser<G2C_ClientLoginResponse>(() => (G2C_ClientLoginResponse)MessagePool.Instance.Fetch(typeof(G2C_ClientLoginResponse)));
    public static pb::MessageParser<G2C_ClientLoginResponse> Parser { get { return _parser; } }
